            ...
            <div class="row justify-content-center" style="margin-right: 20px;">
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <form method="GET" action="/login/oubliPost">
                            ...
                            <div style="margin-bottom: 25px; margin-left: 90px; margin-top: 30px;" class="input-group">             
                                ...
                                <div style="margin-bottom: 25px; margin-left: 90px;" class="input-group">
                                                ...
                                                <input id="cle" type="text" class="form-control" name="cle" placeholder="Saisissez votre mots cle" required style="width: 300px; ">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row" >
                                        <p style="margin-top: 20px;">Pas encore de compte ? <a href="/login/register">S'INSCRIRE</a></p> 
                                    </div>
                            </div>
                        </form>
                        </div>
