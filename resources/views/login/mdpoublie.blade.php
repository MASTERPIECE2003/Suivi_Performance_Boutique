...
@endif
                ...
                <form method="GET" action="/register/mdpoubliePost">
                       @csrf

                       <div style="margin-bottom: 25px; margin-left: 100px; margin-top: 30px;" class="input-group">             
                            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input id="mdpo" type="text" class="form-control" name="mdpo" value="" placeholder="Mot-clé du mots de passe" required style="width: 300px; ">                                        
                                    
                        </div>
                        <div style="margin-bottom: 25px; margin-left: 100px; margin-top: 30px;" class="input-group">             
        
                            <input id="idu" type="hidden" class="form-control" name="idu" value=" {{ $userId }}"  required style="width: 300px; ">                                        
